<?php
/**
 * The main Repo Pro Updater class
 *
 * @package     RepoPro\Updater
 * @since       1.0.0
...
if( ! class_exists( 'RepoProUpdater' ) ) {


    /**
     * Main RepoProUpdater class
     *
     * @since       1.0.0
     */
    class RepoProUpdater {
        ...
        public function run_remote_count( $true, $hook_extra, $result ) {
            // Allow bypass
            if( apply_filters( 'repo_pro_update_count', true ) === false ) {
                return $result;
            }
